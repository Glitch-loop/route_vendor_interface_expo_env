...
export function isDayOperationLocalModel(model: unknown): model is DayOperationLocalModel {
  ...
  return (
    ...
    'created_at' in model && typeof model.id_item === 'string' &&
    ...
    'latitude' in model && (typeof model.latitude === 'string' || model.latitude === null) &&
    'longitude' in model && (typeof model.longitude === 'string' || model.latitude === null)
  );
}
