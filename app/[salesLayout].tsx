...
const salesLayout = () => {
  ...
  */
  ...
  const handlerSetProductDevolution = (declaredProductDevolution: RouteTransactionDescriptionDTO[]) => {
  ...
  */
  const handlerSetProductReposition = (productsToCommit: RouteTransactionDescriptionDTO[]) => {
  ...
  const handlerSetSaleProduct = (productsToCommit: RouteTransactionDescriptionDTO[]) => {
    if (productInventoryMap !== undefined) {
      setProductSale(
        processProductCommitedValidation(productInventoryMap, productsToCommit, productReposition, false));
    }
  };
